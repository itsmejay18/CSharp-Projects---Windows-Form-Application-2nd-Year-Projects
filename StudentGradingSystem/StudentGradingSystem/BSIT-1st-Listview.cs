...
{
    public partial class BSIT_1st_Listview : Form
    {
      
        public BSIT_1st_Listview()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    string constring = "server=localhost;uid=root;pwd=root;database=bsit1styear";
                    string sql = "INSERT INTO bsit1styear.`bsit1styear-1stsem` (`student id#`, `fullname`, `subject 1`, `subject 2`, `subject 3`, `subject 4`, `subject 5`, `subject 6`, `subject 7`, `subject 8`, `subject 9`, `percentage`, `grade point`, `equivalence`) " +
        ...
        private void LoadDataFromDatabase()
        {
            ...
            {
                string constring = "server=localhost;uid=root;pwd=root;database=bsit1styear";
                string sql = "SELECT `student id#`, `fullname`, `subject 1`, `subject 2`, `subject 3`, `subject 4`, `subject 5`, `subject 6`, `subject 7`, `subject 8`, `subject 9`, `percentage`, `grade point`, `equivalence` FROM bsit1styear.`bsit1styear-1stsem`";
        ...
        private void DeleteRecordFromDatabase(string studentId)
        {
            ...
            {
                string constring = "server=localhost;uid=root;pwd=root;database=bsit1styear";
                string sql = "DELETE FROM  bsit1styear.`bsit1styear-1stsem` WHERE `student id#` = @studentId";
        ...
        private void UpdateRecordInDatabase(string studentId)
        {
            ...
            {
                string constring = "server=localhost;uid=root;pwd=root;database=bsit1styear";
                string sql = "UPDATE bsit1styear.`bsit1styear-1stsem` SET `fullname` = @fullname, `subject 1` = @subject_1, `subject 2` = @subject_2, `subject 3` = @subject_3, `subject 4` = @subject_4, `subject 5` = @subject_5, `subject 6` = @subject_6, `subject 7` = @subject_7, `subject 8` = @subject_8, `subject 9` = @subject_9, `percentage` = @percentage, `grade point` = @grade_point, `equivalence` = @equivalence WHERE `student id#` = @studentId";
        ...
        private void BSIT_1st_Listview_Load(object sender, EventArgs e)
        {
        ...
        {
            string searchText = textBox12.Text.ToLower();
        ...
        private void Filterlistview(String searchText)
        {
            ...
            {
                item.BackColor = item.SubItems[1].Text.ToLower().Contains(searchText) ? Color.White:Color.LightGray;
                item.ForeColor = item.BackColor == Color.White ? Color.Black : Color.LightGray; 
