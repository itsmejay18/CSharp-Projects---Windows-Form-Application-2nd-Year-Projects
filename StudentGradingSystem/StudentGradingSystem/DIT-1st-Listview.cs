...
{
    public partial class DIT_1st_Listview : Form
    {
        public DIT_1st_Listview()
        {
            InitializeComponent();
        }

        private void DIT_1st_Listview_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (listView1.SelectedItems.Count > 0)
            {
                ...
                // Update calculated results in ListView
