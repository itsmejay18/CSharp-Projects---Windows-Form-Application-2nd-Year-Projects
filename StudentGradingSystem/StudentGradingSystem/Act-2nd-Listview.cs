...
{
    public partial class Act_2nd_Listview : Form
    {
        public Act_2nd_Listview()
        {
            InitializeComponent();
        }
        ...
        private void Act_2nd_Listview_Load(object sender, EventArgs e)
        {
            listView1.Columns.Add("STUDENT ID#", 100);
            listView1.Columns.Add("FULLNAME", 120);
            listView1.Columns.Add(" CS611", 65);
            listView1.Columns.Add("GEC604", 65);
            listView1.Columns.Add("GEC605", 65);
            listView1.Columns.Add("GEC609", 65);
            listView1.Columns.Add("ISSA611", 65);
            listView1.Columns.Add("ISSA612", 65);
            listView1.Columns.Add("IT601", 65);
            listView1.Columns.Add("NSTP601", 65);
            listView1.Columns.Add("PE601", 65);
        ...
        {
            ACT_Year_Choosing aCT_Year_Choosing = new ACT_Year_Choosing();
            this.Hide();
            aCT_Year_Choosing.Show();
        }
    }
}
