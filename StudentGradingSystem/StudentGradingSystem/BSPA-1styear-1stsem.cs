...
{
    public partial class BSPA_1styear_1stsem : Form
    {
        public BSPA_1styear_1stsem()
        {
            InitializeComponent();
        }

        private void BSPA_1styear_1stsem_Load(object sender, EventArgs e)
        {
        ...
        { // back button Selection of year and semester
            IBEG iBEG = new IBEG();
            this.Hide();
            iBEG.Show();
        }
        ...
        { // to click the first row && first column location in list view
            if (listView1.SelectedItems.Count > 0)
            {
