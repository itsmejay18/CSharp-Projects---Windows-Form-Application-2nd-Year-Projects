...
{
    public partial class BSIT_3rd_Listview : Form
    {
        public BSIT_3rd_Listview()
        {
            InitializeComponent();
        }
            ...
            else
            {
                try
                {
                    string constring = "server=localhost;uid=root;pwd=root;database=bsitr3dyear";
                    string sql = "INSERT INTO bsit3rdyear.`bsit3rdyear_1stsem` (`student id#`, `fullname`, `subject 1`, `subject 2`, `subject 3`, `subject 4`, `subject 5`, `subject 6`, `subject 7`, `subject 8`, `subject 9`, `percentage`, `grade point`, `equivalence`) " +
        ...
        private void BSIT_3rd_Listview_Load(object sender, EventArgs e)
        {
        ...
        private void DeleteRecordFromDatabase(string studentId)
        {
            try
            {
                string constring = "server=localhost;uid=root;pwd=root;database=bsit3rdyear";
                string sql = "DELETE FROM  bsit3rdyear.`bsit3rdyear_1stsem` WHERE `student id#` = @studentId";
        ...
        private void UpdateRecordInDatabase(string studentId)
        {
            ...
            {
                string constring = "server=localhost;uid=root;pwd=root;database=bsit3rdyear";
                string sql = "UPDATE bsit3rdyear.`bsit3rdtyear_1stsem` SET `fullname` = @fullname, `subject 1` = @subject_1, `subject 2` = @subject_2, `subject 3` = @subject_3, `subject 4` = @subject_4, `subject 5` = @subject_5, `subject 6` = @subject_6, `subject 7` = @subject_7, `subject 8` = @subject_8, `subject 9` = @subject_9, `percentage` = @percentage, `grade point` = @grade_point, `equivalence` = @equivalence WHERE `student id#` = @studentId";
